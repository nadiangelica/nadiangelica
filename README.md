...
|-----------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [The Bookclub](https://github.com/nadiangelica/Makers-Website-Automation-Challenge.git)   | Final Group Project as a QE student at Makers Academy. For this Project I collaborated with Developers to ensure high quality via constructive documentation, code reviews and various testing methods, including Automation.                                           | Documentation, Code Reviews, Accessibility Testing, Selenium WebDriver, Java, JUnit, Git  
