...
|-----------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Chitter   | Built Chitter, a Twitter clone, independently after graduation, showcasing my ability to conceptualize, design, and develop a comprehensive web application with user authentication, post creation, editing, and deletion functionalities.                                          | Ruby, SQL, Postman, TablePlus, HTML, CSS, Bootstrap, Git                                                                                                                                                |
| Enaidle   | Makers academy final project. Enaidle is a user-friendly web application designed to facilitate volunteering and enable organizations to effectively advertise their needs.                                                                                                  | MongoDB, Express, React, Node.js, Jest, Cypress, Bootstrap , TablePlus, Postman, Git                                                                                                                                        |
...
| MakersBnB | Makers Academy group project, a webapp to allow homeowners to offer up their space to short-term renters and users to see those spaces to rent.                                                                                                                             | Ruby, SQL, Sinatra, HTML, CSS, Postman, TablePlus, Git                                                                                                                                                  |
